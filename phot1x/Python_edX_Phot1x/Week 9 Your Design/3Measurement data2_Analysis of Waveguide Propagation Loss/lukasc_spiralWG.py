...
url = [ 'https://www.dropbox.com/s/anlo8zmydrji1f8/LukasC_SpiralWG0kTM_1293.mat?dl=1',
        'https://www.dropbox.com/s/yvdfgl8qoq3d0fz/LukasC_SpiralWG5kTM_1296.mat?dl=1',
        'https://www.dropbox.com/s/rossgslht5r5cq7/LukasC_SpiralWG10kTM_1294.mat?dl=1',
        'https://www.dropbox.com/s/vj4uf6u59h9vt60/LukasC_SpiralWG30kTM_1295.mat?dl=1']
...
plt.title('Optical spectra for the' + deviceName + 'test structures', fontsize = FONTSIZE)
...
plt.xlabel('Number of ' + deviceName, fontsize = FONTSIZE)
plt.ylabel('Insertion Loss (dB)', fontsize = FONTSIZE)
plt.title('Cut-back method,' + deviceName +', insertion loss, at 1550 nm', fontsize = FONTSIZE)
plt.legend()
...
plt.annotate('Fit results, with 95% confidence intervals:', xy=(0.5, -30))
plt.annotate('slope is ='+'%.3f' %A[1] + ' +/- ' + '%.3f' %SlopeError95CI + ' dB/'+deviceName, xy=(0.5, -31))
plt.annotate('intercept is = '+'%.3f' %A[0] + ' +/- ' + '%.3f' %InterceptError95CI + 'dB', xy=(0.5, -32))
plt.show()
print ('Cut-back method,' + deviceName + 'insertion loss, at', lam0*1e9, 'nm is =', -A[1], 'dB/'+deviceName)
...
plt.legend(loc = 3)
plt.title('Cut-back method,' + deviceName + 'insertion loss, wavelength dependance')
