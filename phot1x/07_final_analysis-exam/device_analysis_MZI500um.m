...
dL = 500;  % 297.4; % um
data_name = 'data\christopherphenicie_MZI500um.mat';
...
y_data = smoothdata(amplitude_fit, 'gaussian', 15);
...
% 
% nx_init = [n1, n2, n3]
nx_init = [2.4579, -1.13, -0.06];
% nx_init = simulated_n;

alpha_init = 3.0e-3;  % propagation loss [micron^-1]
device_loss = 1.8;
...
xfit
xerr'
save('MZI500um_fit.mat', 'xfit', 'xerr', 'fsr', 'fsr_err', 'dL')
