...
dL = 30;  % 297.4; % um
data_name = 'data\christopherphenicie_MZI30um.mat';
...
% range!!
lambda_min = 1.500e-6;  % 1.521e-6;
lambda_max = 1.580e-6;  % 1.569e-6;
% lambda0 = 1.545;
...
% 
% nx_init = [n1, n2, n3]
nx_init = [2.46, -1.1, -0.0032]; % [2.46, -1.1385, -0.0646]
% nx_init = simulated_n;

alpha_init = 1.5e-3;  % propagation loss [micron^-1]
device_loss = 0.8;
...
xfit
xerr'
save('MZI30um_fit.mat', 'xfit', 'xerr', 'fsr', 'fsr_err', 'dL')
