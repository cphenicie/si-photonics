...
% This is the device labelled MI5, it is on the top
dL = 2*(2297.40 - 11.69) + 87.81 - 82.63;  % 297.4; % um
% dL = 2*2200;  % 297.4; % um
% dL = 2*2150;  % 297.4; % um
data_name = 'data\christopherphenicie_MIB.mat';
...
nx_init = [2.4697, -1.13, -0.17]; % [2.46, -1.1385, -0.0646]
% nx_init = simulated_n;
...
save('MIB_fit.mat', 'xfit', 'xerr', 'fsr', 'fsr_err', 'dL')
