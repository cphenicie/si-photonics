...
dL = 50;  % 297.4; % um
data_name = 'data\christopherphenicie_MZI50um.mat';
...
% range!!
lambda_min = 1.517e-6;  % 1.521e-6;
lambda_max = 1.568e-6;  % 1.569e-6;
% lambda0 = 1.545;
...
good_locs_idx = find(1.5 < x_data(locs) & x_data(locs) < 1.6);
...
% 
% nx_init = [n1, n2, n3]
nx_init = [2.457, -1.13, 0.008]; % [2.4432   -1.1441    0.3551]
% nx_init = simulated_n;

alpha_init = 7.9e-3;  % propagation loss [micron^-1]
device_loss = 1.3;
...
% options=optimoptions(@lsqcurvefit, 'StepTolerance', 1e-7);
...
xfit
xerr'
save('MZI50um_fit.mat', 'xfit', 'xerr', 'fsr', 'fsr_err', 'dL')
