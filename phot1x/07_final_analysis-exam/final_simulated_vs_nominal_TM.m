...
dL = 312.049; % um
data_name = 'LukasChrostowski_MZI_TM_oneside_1246.mat';

loopback_name = 'LukasChrostowski_MZI_TM_oneside_1246.mat';
...
simulated_n = [1.7768, -1.2718, 1.801];

% Set up loading corner analysis data
corner_file_dir = 'C:\Users\chris\Documents\GitHub\si-photonics\phot1x\07_final_analysis-exam\corner_analysis';
...
y_data = smoothdata(amplitude_fit);
