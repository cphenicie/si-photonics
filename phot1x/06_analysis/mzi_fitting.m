...
legend('All corrected data', 'Data in wl range')
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
nx_init = [2.5, -1, 0];   %%%%%%%%%%%% CHANGE THE FIRST PARAMETER
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
plot (lambda*1e6, amplitude);
hold all;
plot(lambda*1e6, T_MZI(xfit, lambda*1e6),'LineWidth',1); 
xlabel ('Wavelength [\mum]');
ylabel ('Transmission [dB]');
axis tight
...
if (ge(r2,0.8))
  ...
  plot(lambda*1e6, ng, 'LineWidth',1);
  xlabel ('Wavelength [\mum]');
